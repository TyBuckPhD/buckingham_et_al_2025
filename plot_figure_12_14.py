...
if __name__ == "__main__":
    ...
    pta.plot_selected_trajectories(filename='figures/figure_12_type1_trajectories.png')

    # Step 7: Plot time series of vorticity components (absolute, stretching, tilt) for the selected trajectories
    avo, stretch, tilt = pta.plot_vorticity_components(filename='figures/figure_14_type1_vorticity_budget.png')
...
if __name__ == "__main__":
    ...
    levels = np.arange(-24, 24 + 3, 3) # Array of vorticity levels for plotting
    ...
    pta.plot_selected_trajectories(filename='figures/figure_09_type2_trajectories.png')

    # Step 7: Plot time series of vorticity components (absolute, stretching, tilt) for the selected trajectories
    avo, stretch, tilt = pta.plot_vorticity_components(filename='figures/figure_11_type2_vorticity_budget.png')